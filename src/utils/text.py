...
def draw_multiline_text(screen:Surface, position:tuple[int, int], text:str, size:int, colour:tuple[int, int, int], bold:bool=False, max_x:int=SCREEN_SIZE[0]-BORDER) -> None:
